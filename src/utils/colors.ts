import type { CSSColorValue, RGBAColorValue } from '@unocss/rule-utils'
...
export function hex2rgba(hex = ''): RGBAColorValue | undefined {
  ...
  if (color != null) {
    ...
    if (alpha == null) return components as [number, number, number]
...
function parseCssCommaColorFunction(
  color: string
): CSSColorValue | false | undefined {
